...
date: "last updated: `r format(Sys.time(), '%A %d %B %Y at %X')`"
...
?id=%SURVEY_CODE%
```
at the end of the URL. So if the Qualtrics URL (Anonymous Survey Link) is:
```{r, class.source='klippy', eval=FALSE}
...
```{r, class.source='klippy', eval=FALSE}
psychologyresearchbu.sona-systems.com/webstudy_credit.aspx?experiment_id=2292&credit_token=45afb612c6864e6da9236d2a16142bf0&survey_code=${e://Field/id}
```
